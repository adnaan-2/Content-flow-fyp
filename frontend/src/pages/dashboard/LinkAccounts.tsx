          ...
          {socialPlatforms.map((platform) => {
            ...
            return (
              <div 
                ...
                className="bg-white dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl p-6 hover:border-gray-300 dark:hover:border-gray-700 transition-all duration-300 hover:bg-gray-50 dark:hover:bg-gray-900/70 shadow-sm"
              >
                {/* Platform Header */}
                            ...
                            {account.platformData?.pages && account.platformData.pages.length > 0 && (
                              <div className="ml-6 mt-3 space-y-2">
                                {account.platformData.pages.map((page) => (
                                  <div key={page.id} className="bg-gray-50 dark:bg-gray-800/30 rounded-lg p-3 border border-gray-200 dark:border-gray-700/30 relative">
                                    {/* Connection line */}
                      ...
                      <div>
                        {platformConnectedAccounts.map((account) => (
                          <div key={account._id} className="mb-3">
                            <div className="bg-white dark:bg-gray-800/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700/50 shadow-sm">
                              <div className="flex items-center space-x-3">
                                {account.profilePicture && (
                                  <img 
                                    src={account.profilePicture} 
                ...
                <button 
                  className={`w-full py-3 px-4 rounded-lg font-medium transition-all duration-300 ${
                    isConnecting
                      ...
                      : isConnected
                        ? 'bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-400 border border-red-200 dark:border-red-800 hover:bg-red-200 dark:hover:bg-red-900/70'
